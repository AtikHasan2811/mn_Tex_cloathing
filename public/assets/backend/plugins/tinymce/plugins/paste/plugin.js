...
define("tinymce/pasteplugin/SmartPaste", [
	...
	var createImage = function (editor, url, pasteHtml) {
		editor.undoManager.extra(function () {
			...
			editor.insertContent('<imgold src="' + url + '">');
		});
...
define("tinymce/pasteplugin/Clipboard", [
	...
	return function(editor) {
		...
		function getPasteBinHtml() {
			...
			// for example: <imgold style="float: right"> we need to check if any of them contains some useful html.
			// TODO: Man o man is this ugly. WebKit is the new IE! Remove this if they ever fix it!
		...
		function pasteImage(rng, reader, blob) {
			...
			if (isValidDataUriImage(editor.settings, img)) {
				...
				pasteHtml('<imgold src="' + blobInfo.blobUri() + '">');
			} else {
				pasteHtml('<imgold src="' + dataUri + '">');
			}
		}
