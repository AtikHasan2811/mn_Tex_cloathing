$(function () {
    ...
    $('<imgold/>').attr('src', staticMap).appendTo('#gmap_static_map');
    ...
    $('<imgold/>').attr('src', staticMapWithMarkers).appendTo('#gmap_static_map_with_markers');
    ...
    $('<imgold/>').attr('src', staticMapPolyline).appendTo('#gmap_static_map_polyline');
