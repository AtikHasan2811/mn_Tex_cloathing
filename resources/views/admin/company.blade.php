...
@section('content')
    <div class="container-fluid">
                        ...
                        <div class="header">
                            ...
                            <div class="col text-right">
                                <a style="width: 200px;" type="button" class="btn btn-outline-info  float-right "
                                    data-toggle="modal" data-target="#exampleModalinsert" value="Add Photo">Add Company</a>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="zoom"><img src="{{ url('uploads/about/' . $value->image) }}"
                                                        style="height: 50px;width: 80px;" alt=""></div>
                                            </td>
                                            <td>{{ $value->name }}</td>
                                            ...
                                            <td class="text-center" style="width: 15%;">
                                                ...
                                                <button class="btn btn-danger waves-effect" type="button"
                                                    onclick="companydestroy({{ $value->id }})">
                                                    <i class="material-icons">delete</i>
                                                </button>
                                                <form id="delete-form-{{ $value->id }}"
                                                    action="{{ url('companydestroy/' . $value->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <form action="{{ url('companyupdate/') }}" enctype="multipart/form-data" method="post">
                @csrf
        ...
        <div class="modal fade modal-xl" id="exampleModalinsert" tabindex="-1" role="dialog"
            ...
            <form action="{{ url('company/store') }}" enctype="multipart/form-data" method="post">
                @csrf
