...
{{--        id	name	discription	image	logo	status	created_at	updated_at--}}
        <div class="section">
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="col text-right">
                                <a style="width: 200px;" type="button" class="btn btn-outline-info  float-right " data-toggle="modal" data-target="#exampleModalinsert"  value="Add Photo">Add Certificate</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 15%;">
                                            ...
                                            <button class="btn btn-danger waves-effect" type="button"
                                                    onclick="certificatedestroy({{$value->id}})">
                                                <i class="material-icons">delete</i>
                                            </button>
                                            <form id="delete-form-{{ $value->id }}"
                                                  action="{{ url('certificatedestroy/'.$value->id) }}" method="POST"
                                                  style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
...
{{--        id	name	discription	image	logo	status	created_at	updated_at--}}
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <form action="{{url('certificateupdate/')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            {{--                            <input type="hidden" name="id"  id="id" class="form-control" value="" >--}}
                            <div class="form-group">
                                <label for="usr">Select Logo </label>
    ...
    <!-- Modal  for insert-->
        <div class="modal fade modal-xl" id="exampleModalinsert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form  action="{{url('certificate/store')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Certificate Info</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <label for="email_address">Decription</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" required name="description"  id="abc" class="form-control" value="" >
                                </div>
                            </div>
        ...
        @push('js')
            ...
            <script type="text/javascript">
                ...
                function certificatedestroy(id) {
                    swal({
                        title: 'Are you sure?',
