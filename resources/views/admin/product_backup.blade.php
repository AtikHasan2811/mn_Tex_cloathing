                                ...
                                <tbody>
                                    @foreach ($products as $key=>$product)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="zoom">
                                                    <img src="{{url('uploads/about/'.$product->image)}}"style="height: 60px;width: 60px;"alt="">
                                                </div>
                                            </td>
                                            <td>{{$product->name}}</td>
                                            ...
                                            <td class="text-center" style="width: 15%;">
                                                <a href="#" class="btn btn-info waves-effect getdata" data-toggle="modal"
                                                    ...
                                                    data-status="{{ $product->status }}" data-target="#exampleModal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="email_address">Name</label>
                                <div class="form-line">
                                    <input type="text" name="name" id="name" placeholder="Enter Product Name" class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="email_address">Description</label>
                                <div class="form-line">
                                    <textarea name="description" class="form-control" id="" cols="30" rows="5" placeholder="Enter Product Description..."></textarea>
                                </div>
                            </div>
