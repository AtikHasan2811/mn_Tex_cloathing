...
@section('content')
    <div class="container-fluid">
                                ...
                                Gallary TABLE
                                        ...
                                        <div class="col text-right">
                                            <a style="width: 200px;" type="button"
                                                ...
                                                data-target="#exampleModalinsert" value="Add Photo">Add Gallary</a>
                                        </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 15%;">
                                                <a href="#" class="btn btn-info waves-effect getdata" data-toggle="modal"
                                                    data-id="{{ $value->id }}" data-caption="{{ $value->caption }}"
                                                    data-description="{{ $value->description }}"
                                                    data-status="{{ $value->status }}" data-target="#exampleModal">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <button class="btn btn-danger waves-effect" type="button"
                                                    onclick="gallarydestroy({{ $value->id }})">
                                                    <i class="material-icons">delete</i>
                                                </button>
                                                <form id="delete-form-{{ $value->id }}"
                                                    action="{{ url('gallarydestroy/' . $value->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <form action="{{ url('gallaryupdate/') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea name="description" class="form-control" id="description" cols="30" rows="5" class="from-control"></textarea>
                                </div>
                            </div>
        ...
        <div class="modal fade modal-xl" id="exampleModalinsert" tabindex="-1" role="dialog"
            ...
            <form action="{{ url('gallary/store') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Gallary Info</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" required name="caption" id="caption" class="form-control" value="">
                                </div>
                            </div>
    ...
    @push('js')
        ...
        {{-- //id caption discription image status created_at
        updated_at--}}
