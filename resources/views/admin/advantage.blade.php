...
{{--                                    <div class="row">--}}
                                        <div class="col text-right">
                                            <a style="width: 200px;" type="button" class="btn btn-outline-info  float-right " data-toggle="modal" data-target="#exampleModalinsert"  value="Add Photo">Add About</a>
...
{{--                        id	name	description	image	status	created_at	updated_at--}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 15%;">
                                            ...
                                            <button class="btn btn-danger waves-effect" type="button"
                                                    onclick="advantagedestroy({{$value->id}})">
                                                <i class="material-icons">delete</i>
                                            </button>
                                            <form id="delete-form-{{ $value->id }}"
                                                  action="{{ url('advantagedestroy/'.$value->id) }}" method="POST"
                                                  style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <form action="{{url('advantageupdate/')}}" enctype="multipart/form-data" method="post">
                @csrf
...
{{--                            <input type="hidden" name="id"  id="id" class="form-control" value="" >--}}
    ...
    <!-- Modal  for insert-->
        <div class="modal fade modal-xl" id="exampleModalinsert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form  action="{{url('advantage/store')}}" enctype="multipart/form-data" method="post">
                @csrf
