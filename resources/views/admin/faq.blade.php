...
{{--                                    <div class="row">--}}
                                        <div class="col text-right">
                                            <a style="width: 200px;" type="button" class="btn btn-outline-info  float-right " data-toggle="modal" data-target="#exampleModalinsert"  value="Add Photo">Add FAQ</a>
...
{{--                     	id	question	answer	description	image	status	created_at	updated_at	--}}
 ...
 {{--                     	id	question	answer	description	image	status	created_at	updated_at	--}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 15%;">
                                            ...
                                            <button class="btn btn-danger waves-effect" type="button"
                                                    onclick="faqdestroy({{$value->id}})">
                                                <i class="material-icons">delete</i>
                                            </button>
                                            <form id="delete-form-{{ $value->id }}"
                                                  action="{{ url('faqdestroy/'.$value->id) }}" method="POST"
                                                  style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <form action="{{url('faqupdate/')}}" enctype="multipart/form-data" method="post">
                @csrf
...
{{--                        <p id="abc"></p>--}}
                ...
                <input type="hidden" name="id"  id="id" class="form-control" value="" >
                            ...
                            <label for="email_address">Answer</label>
                            <div class="form-group">
                                <div class="form-line">
...
{{--                            <input type="hidden" name="id"  id="id" class="form-control" value="" >--}}
    ...
    <!-- Modal  for insert-->
        <div class="modal fade modal-xl" id="exampleModalinsert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form  action="{{url('faq/store')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">FAQ Info</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
