                            ...
                            <h2>
                                News TABLE
                                        ...
                                        <div class="col text-right">
                                            <a style="width: 200px;" type="button" class="btn btn-outline-info  float-right " data-toggle="modal" data-target="#exampleModalinsert"  value="Add Photo">Add News</a>
...
{{--                            //id	title	subtitle	description	date	image	status	created_at	updated_at--}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 15%;">
                                            ...
                                            <button class="btn btn-danger waves-effect" type="button"
                                                    onclick="newsdestroy({{$value->id}})">
                                                <i class="material-icons">delete</i>
                                            </button>
                                            <form id="delete-form-{{ $value->id }}"
                                                  action="{{ url('newsdestroy/'.$value->id) }}" method="POST"
                                                  style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <form action="{{url('newsupdate/')}}" enctype="multipart/form-data" method="post">
                @csrf
...
{{--                                <div class="form-line">--}}
                            ...
                            <label for="email_address">Subtitle </label>
                            <div class="form-group">
                                <div class="form-line">
